...
def app():
    ...
    df_email = pd.read_csv('data_csv/top10_email_users.csv')
    df_game = pd.read_csv('data_csv/top10_gameApp_users.csv')
    df_google = pd.read_csv('data_csv/top10_google_users.csv')
    df_netflix = pd.read_csv('data_csv/top10_netflix_users.csv')
    df_otherAct = pd.read_csv('data_csv/top10_otherAct_users.csv')
    df_social = pd.read_csv('data_csv/top10_socialMedia_users.csv')
    df_youtube = pd.read_csv('data_csv/top10_youtube_users.csv')
    df_session = pd.read_csv('data_csv/top10_user_session.csv')
    df_DLUL = pd.read_csv('data_csv/top10_DLUL_users.csv')

    st.header("Top 3 best Handset Manufacturers")
    st.image('data_csv/3_best_handset_manufacturers.png')

    st.header("Top 5 best Handsets used for communication")
    st.image('data_csv/5 best phones used in communication.png')
    
    st.header("Data transfers and overall data usage correlation.")
    st.image('data_csv/corellation.png')
    st.markdown(
    ...
    st.image('data_csv/engclusters.png')
